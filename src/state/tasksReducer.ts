...
type GeneralACType = removeTaskACType | addTaskACType | changeCheckBoxACType | changeTitleTaskACType | addTasksInTodolistACType
...
export const addTasksInTodolistAC = (newID: string) => {
    return {
        type: 'ADD-TODOLIST',
        payload: {
            newID
